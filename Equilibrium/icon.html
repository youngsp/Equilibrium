                ...
                <div class="navbar navbar-inverse navbar-static-top">
                    <div class="navbar-inner">
                        <div class="container-fluid">
                            ...
                            <a class="brand" href="index.html">Metis</a> <!-- .topnav -->
            ...
            <header class="head">
                ...
                <div class="main-bar">
                    <div class="container-fluid">
                        <div class="row-fluid">
                            <div class="span12">
                                <h3><i class="icon-magic"></i> Icons &amp; Buttons</h3>
                            </div>
                        </div>
                        <!-- /.row-fluid -->
                    </div>
            ...
            <div id="left">
                ...
                <ul id="menu" class="unstyled accordion collapse in">
                    ...
                    <li class="accordion-group active">
                        ...
                        <ul class="collapse in" id="component-nav">
                        ...
                        <div class="span12 inner">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span12">
                                    ...
                                    <div class="box">
                                        <header>
                                            <div class="icons"><i class="icon-magic"></i></div>
                                            <h5>Icons & Button</h5>

                                            <div class="toolbar">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a data-toggle="tab" href="#icon-container">Font Awesome Icons</a></li>
                                                    <li><a data-toggle="tab" href="#button-container">Buttons</a></li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="body tab-content">
                                            <!-- #icon-container.tab-pane fade -->
                                            <div id="icon-container" class="tab-pane active">
                                            ...
                                            <div id="new">
                                                ...
                                                <div class="row-fluid the-icons">
                                                    ...
                                                    <div class="span3"><a href="../icon/dribble"><i class="icon-dribble"></i> icon-dribble</a></div>
                                            ...
                                            <!-- /#icon-container.tab-pane fade -->
                                            <!-- #button-container.tab-pane fade -->
                                            <div id="button-container" class="tab-pane fade">
                                                <div class="row-fluid">
                                                    <div class="span4">
                                                        <div class="box">
                                                            <header>
                                                                <div class="icons"><i class="icon-reorder"></i></div>
                                                                <h5>Button</h5>
                                                                <ul class="nav pull-right">
                                                                    <li>
                                                                        <button class="btn btn-mini btn-warning">button</button>
                                                                    </li>
                                                                </ul>
                                                            </header>
                                                            <div class="body">
                                                                <table class="table table-bordered table-striped">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <button class="btn btn-metis-1" type="button">Metis-1</button>
                                                                            </td>
                                                                            <td><code>btn btn-metis-1</code></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <button class="btn btn-metis-2" type="button">Metis-2</button>
                                                                            </td>
                                                                            <td><code>btn btn-metis-2</code></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <button class="btn btn-metis-3" type="button">Metis-3</button>
                                                                            </td>
                                                                            <td><code>btn btn-metis-3</code></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <button class="btn btn-metis-4" type="button">Metis-4</button>
                                                                            </td>
                                                                            <td><code>btn btn-metis-4</code></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <button class="btn btn-metis-5" type="button">Metis-5</button>
                                                                            </td>
                                                                            <td><code>btn btn-metis-5</code></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                            ...
                                                            <div class="body">
                                                                <div>
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        <button type="button" class="btn btn-large btn-block btn-metis-5">Block level button</button>
...
&lt;a href="#" class="btn btn-large disabled"&gt;Link&lt;/a&gt;
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span4">
                                                        <div class="box">
                                                            <header><h5>Button Group</h5>
                                                                <ul class="nav pull-right">
                                                                    <li>
                                                                        <div class="btn-group">
                                                                            <button class="btn btn-mini btn-primary">1</button>
                                                                            <button class="btn btn-mini btn-info">2</button>
                                                                            <button class="btn btn-mini btn-danger">3</button>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </header>
                                                                ...
                                                                <div class="block">
                                                                    ...
                                                                    <div class="btn-toolbar">
                                                                        <div class="btn-group">
                                                                            <button class="btn">1</button>
                                                                            <button class="btn">2</button>
                                                                            <button class="btn btn-metis-2">3</button>
                                                                            <button class="btn">4</button>
                                                                        </div>
                                                                        <div class="btn-group">
                                                                            <button class="btn btn-metis-1">5</button>
                                                                            <button class="btn">6</button>
                                                                            <button class="btn btn-metis-3">7</button>
                                                                        </div>
                                                                        <div class="btn-group">
...
&lt;/div&gt;
                                                                ...
                                                                <div class="block">
                                                                    ...
                                                                    <div class="btn-group btn-group-vertical">
                                                                        <button class="btn btn-metis-1" type="button"><i class="icon-align-left"></i></button>
                                                                        <button class="btn btn-metis-2" type="button"><i class="icon-align-center"></i></button>
...
&lt;/div&gt;
                                                    ...
                                                    <div class="span8">
                                                        <div class="box">
                                                            <header>
                                                                <h5>Button dropdown menus</h5>
                                                                <ul class="nav pull-right">
                                                                    <li>
                                                                        <div class="btn-group">
                                                                            <button class="btn btn-metis-1 dropdown-toggle" data-toggle="dropdown">Action <span
                                                                ...
                                                                <div class="block">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="btn-toolbar">
                                                                            ...
                                                                            <!-- /btn-group -->
                                                                            <div class="btn-group">
                                                                                <button class="btn btn-metis-2 dropdown-toggle" data-toggle="dropdown">Danger <span
                                                                                        class="caret"></span></button>
                                                                                <ul class="dropdown-menu">
                                                                                    <li><a href="#">Action</a></li>
                                                                                    <li><a href="#">Another action</a></li>
                                                                            ...
                                                                            <!-- /btn-group -->
                                                                            <div class="btn-group">
                                                                                <button class="btn btn-metis-3 dropdown-toggle" data-toggle="dropdown">Warning <span
                                                                                        class="caret"></span></button>
                                                                                <ul class="dropdown-menu">
                                                                                    <li><a href="#">Action</a></li>
                                                                                    <li><a href="#">Another action</a></li>
                                                                            ...
                                                                            <!-- /btn-group -->
                                                                            <div class="btn-group">
                                                                                <button class="btn btn-metis-4 dropdown-toggle" data-toggle="dropdown">Success <span
                                                                                        class="caret"></span></button>
                                                                                <ul class="dropdown-menu">
                                                                                    <li><a href="#">Action</a></li>
                                                                                    <li><a href="#">Another action</a></li>
                                                                            ...
                                                                            <!-- /btn-group -->
                                                                            <div class="btn-group">
                                                                                <button class="btn btn-metis-5 dropdown-toggle" data-toggle="dropdown">Info <span class="caret"></span>
                                                                                </button>
                                                                                <ul class="dropdown-menu">
                                                                                    <li><a href="#">Action</a></li>
                                                                                    <li><a href="#">Another action</a></li>
                                                                            ...
                                                                            <!-- /btn-group -->
                                                                            <div class="btn-group">
                                                                                <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">Inverse <span
                                                                                        class="caret"></span></button>
                                                                                <ul class="dropdown-menu">
                                                                                    <li><a href="#">Action</a></li>
                                                                                    <li><a href="#">Another action</a></li>
                                                                ...
                                                                <div class="block">
                                                                    ...
                                                                    <div class="btn-toolbar">
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <button class="btn btn-metis-4 dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
                                                                            <ul class="dropdown-menu">
                                                                                <li><a href="#">Action</a></li>
                                                                                <li><a href="#">Another action</a></li>
                                                                                <li><a href="#">Something else here</a></li>
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <button class="btn btn-metis-1 dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
                                                                            <ul class="dropdown-menu">
                                                                                <li><a href="#">Action</a></li>
                                                                                <li><a href="#">Another action</a></li>
                                                                                <li><a href="#">Something else here</a></li>
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <button class="btn btn-metis-3 dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
                                                                            <ul class="dropdown-menu">
                                                                                <li><a href="#">Action</a></li>
                                                                                <li><a href="#">Another action</a></li>
                                                                                <li><a href="#">Something else here</a></li>
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <button class="btn btn-metis-5 dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
                                                                            <ul class="dropdown-menu">
                                                                                <li><a href="#">Action</a></li>
                                                                                <li><a href="#">Another action</a></li>
                                                                                <li><a href="#">Something else here</a></li>
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <button class="btn btn-metis-2 dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
                                                                            <ul class="dropdown-menu">
                                                                                <li><a href="#">Action</a></li>
                                                                                <li><a href="#">Another action</a></li>
                                                                                <li><a href="#">Something else here</a></li>
